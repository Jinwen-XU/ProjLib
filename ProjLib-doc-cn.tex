...
\PLdatestr{} 提供了 \lstinline|\PLdate|\meta{yyyy-mm-dd} 命令，并将 \meta{yyyy-mm-dd} 转换为对应语言的日期格式显示。关于如何选定语言，请参阅关于 \PLlang{} 的小节。
...
\begin{code}
  ...
  \CreateTheorem{proofidea}
\end{code}
可以分别定义不编号的环境 \lstinline|proofidea*| 和编号的环境 \lstinline|proofidea|，它们支持在简体中文语境中使用，效果如下所示 (具体样式与所在的文档类有关) :
